public class Main {
    public static void main(String[] args) {
        ...
        Endereco enderecoA = new Endereco(2, "Rua taumautugo baz", 346, "cetam", "69070760", "Manaus", "Amazonas", "Brasil");
        ...
        Cliente pedro = new Cliente("Pedro", "126372312-01", contatoB, contatoA, enderecoB, enderecoA);
