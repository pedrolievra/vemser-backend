...
SELECT logradouro, cep FROM VEMSER_PEDRO.ENDERECO WHERE UPPER(logradouro) LIKE ('A%')
--SELECIONAR TODOS OS ENDERECOS QUE TEM CEP QUE TERMINEM COM 0
SELECT cep FROM VEMSER_PEDRO.ENDERECO WHERE TRIM(cep) LIKE '%0';
...
SELECT * FROM VEMSER_PEDRO.ENDERECO
